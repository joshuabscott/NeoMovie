...
namespace NeoMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            var movies = await _context.Movie.ToListAsync();  // The one job is to go to the database and get all the items, records in the movies table, that have been imported
            return View(movies);    // feed the data to the view to display
        }
